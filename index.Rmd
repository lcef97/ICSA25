...
&rarr; Does classroom size incorporate **additional information** we are overlooking? &rarr; example: **demographic** dynamics: classrooms are more crowded in **infrastructural poles** than in **peripheral areas**
...
- **Hyperparameters** posterior summary
  - median $\sigma^2$ (*scale* parameter of the spatial effect) about $31$ points
  - median **range** about $84.7$ kilometers
